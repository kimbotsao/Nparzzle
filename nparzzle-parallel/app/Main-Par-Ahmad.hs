...
import Control.Parallel.Strategies (parList, parMap, rpar, rdeepseq, using)
...
parallelNeighbors p = concat $ parMap rpar (\dir -> fromMaybeMove p dir) [UP, DOWN, LEFT, RIGHT]
